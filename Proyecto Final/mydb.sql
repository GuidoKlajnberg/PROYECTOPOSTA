...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Usuario` (`idUsuario`, `Nombre usuario`, `Contraseña`, `Email`, `Direccion`) VALUES (0, 'Guido', 'gggkk', 'gklajnberg@hotmail.com', 'Dorrego 2450');
INSERT INTO `mydb`.`Usuario` (`idUsuario`, `Nombre usuario`, `Contraseña`, `Email`, `Direccion`) VALUES (1, 'Uri', 'uuuum', 'urimendelberg@gmail.com', 'Honduras 3750');
INSERT INTO `mydb`.`Usuario` (`idUsuario`, `Nombre usuario`, `Contraseña`, `Email`, `Direccion`) VALUES (2, 'Ezequiel', 'Binker', 'bink@bink.com', 'Mansilla 2233');
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Necesitado` (`idNecesitado`, `Nombre`, `Apellido`, `Edad y Sexo`, `Direccion`) VALUES (0, 'Carlos', 'Gomez', 'Chico', 'Murillo 999');
INSERT INTO `mydb`.`Necesitado` (`idNecesitado`, `Nombre`, `Apellido`, `Edad y Sexo`, `Direccion`) VALUES (1, 'Rodrigo', 'Perez', 'Hombre', 'Lavalle 1221');
